 ...
 *
 * ! Es útil usar find, pero se puede con filter
 * 
 *  - 5. Obtén un array con los coches de los españoles.
 *  - 6. Obtén un array con las personas que tengan un coche de la marca Ford.
 *  - 7. ¡Bonus point! Obtén un array con todas las personas en el que cada persona tenga toda la info de su coche. Ejemplo a continuación:
 * 
 * ```
 * {
    name: "Berto",
